<template>
    <div class="content-wrapper">
        ...
        <custom-app-table :id="tableId" :options="options" @action="getListAction"/>
        ...
        methods: {
            ...
            getListAction(rowData, actionObj, active) {
                ...
                if (actionObj.title == 'Delete') {
                    ...
                    this.selectedUrl = `${actions.REACTION_DATA}/${rowData.id}`;
             ...
             */
            confirmed() {
                let url = `${actions.REACTION_DATA}/${this.rowData.id}`;
